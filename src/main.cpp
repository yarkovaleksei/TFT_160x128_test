...
#define TFT_RST          8
#define TFT_DC           9
#define TFT_POWER_PIN    3

Adafruit_ST7735 tft = Adafruit_ST7735(TFT_CS, TFT_DC, TFT_RST); // For 1.44" and 1.8" TFT with ST7735 use
...
void testdrawtext(const __FlashStringHelper *text, uint16_t color) {
  tft.setCursor(0, 0);
...
void setup(void) {
  ...
  tft.initR(INITR_BLACKTAB); // Use this initializer if using a 1.8" TFT screen
